"""
Django settings for SistemaNomina project.
...
SECRET_KEY = 'django-insecure-&ke10#k2)4o048=4e@30y8^(13(f5fwh$*kj&hfybc-)^2rcpz'
...
ROOT_URLCONF = 'SistemaNomina.urls'
...
WSGI_APPLICATION = 'SistemaNomina.wsgi.application'
